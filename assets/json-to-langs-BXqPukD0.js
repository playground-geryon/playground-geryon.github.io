import{r as i,j as s}from"./vendor-CRMzTT1s.js";import{u as ee,P as te,B as R,y as ne,z as re,S as U,T as z,a as H,a5 as oe,a6 as se,l as ie,m as ae,n as le,ab as ce}from"./mui-vTMdSA3y.js";import{M as X}from"./monaco-editor-CtBg_s_G.js";import"./excel-CUMakpxJ.js";import"./tree-sitter-aGyQ8e2w.js";const q=[{id:"java",label:"Java",language:"java"},{id:"dart",label:"Dart",language:"dart"},{id:"typescript",label:"TypeScript",language:"typescript"}],_=(d,x=2)=>{const g=" ".repeat(x),$=d.split(`
...
`}else if(typeof y=="string")m+=`${e}${u.join(`
`+e)}
${e}private List<String> ${r};

`;else if(typeof y=="number"){const J=Number.isInteger(y)?"Integer":"Double";m+=`${e}${u.join(`
`+e)}
${e}private List<${J}> ${r};

`}else typeof y=="boolean"?m+=`${e}${u.join(`
`+e)}
...
`;continue}if(t&&typeof t=="object"){const y=f(g(h)),J=c(t,p+1);n+=`${e}public static class ${y} {
...
`;continue}if(typeof t=="number"){const y=Number.isInteger(t)?"Integer":"Double";m+=`${e}${u.join(`
`+e)}
${e}private ${y} ${r};
