...
app:
  ...
  features:
    - tree-sitter
    - fallback
`},Vt=()=>{const[t,l]=v.useState("java"),[s,e]=v.useState(""),[r,a]=v.useState([]),[n,i]=v.useState(null),[d,o]=v.useState([]),[p,h]=v.useState(!1),[w,k]=v.useState(null),y=v.useRef(null),C=v.useMemo(()=>r.length,[r]),$=v.useCallback(async R=>{const F=(R??s).trim();if(!F){a([]),o(["코드를 입력하거나 파일을 업로드해 주세요."]),i(null);return}h(!0),k(null);try{const m=await Ft(F,t);a(m.nodes),o(m.diagnostics),i(m.engine)}catch(m){k(m?.message??String(m)),a([]),i(null),h(!1);return}h(!1)},[t,s]),L=v.useCallback(async R=>{if(!R)return;const F=await R.text();e(F),$(F),y.current&&(y.current.value="")},[$]),E=v.useCallback(()=>{const R=Ht[t];e(R),a([]),o([]),i(null),k(null),$(R)},[$,t]),B=v.useCallback(R=>{l(R),e(""),a([]),o([]),i(null),k(null),y.current&&(y.current.value="")},[]);return{languageId:t,changeLanguage:B,source:s,setSource:e,outline:r,outlineCount:C,engine:n,diagnostics:d,loading:p,error:w,handleAnalyze:$,handleFileSelect:L,handleSampleLoad:E,fileInputRef:y,languageOptions:Kt}},Xt={file:c.jsx(dt,{fontSize:"inherit"}),class:c.jsx(ot,{fontSize:"inherit"}),interface:c.jsx(ct,{fontSize:"inherit"}),enum:c.jsx(lt,{fontSize:"inherit"}),method:c.jsx(at,{fontSize:"inherit"}),function:c.jsx(rt,{fontSize:"inherit"}),variable:c.jsx(it,{fontSize:"inherit"}),constant:c.jsx(st,{fontSize:"inherit"}),field:c.jsx(we,{fontSize:"inherit"}),property:c.jsx(we,{fontSize:"inherit"}),component:c.jsx(nt,{fontSize:"inherit"}),struct:c.jsx(tt,{fontSize:"inherit"}),module:c.jsx(et,{fontSize:"inherit"}),namespace:c.jsx(Qe,{fontSize:"inherit"}),htmlTag:c.jsx(Ye,{fontSize:"inherit"}),cssSelector:c.jsx(Ge,{fontSize:"inherit"})},Se=[{kind:"class",label:"클래스"},{kind:"function",label:"함수"},{kind:"interface",label:"인터페이스"},{kind:"struct",label:"구조체/레코드"},{kind:"enum",label:"열거형"},{kind:"method",label:"메서드"},{kind:"variable",label:"변수"},{kind:"constant",label:"상수"},{kind:"field",label:"필드"},{kind:"property",label:"프로퍼티"},{kind:"component",label:"UI 컴포넌트"},{kind:"module",label:"모듈/패키지"},{kind:"namespace",label:"네임스페이스"},{kind:"htmlTag",label:"HTML 태그"},{kind:"cssSelector",label:"CSS 선택자"},{kind:"unknown",label:"기타"}],je=t=>Xt[t]??c.jsx(Je,{fontSize:"inherit"}),Jt={javascript:".js",typescript:".ts",tsx:".tsx",java:".java",kotlin:".kt",python:".py",go:".go",rust:".rs",c:".c",cpp:".cpp,.cc,.cxx,.hpp,.hh,.hxx",csharp:".cs",php:".php",ruby:".rb",scala:".scala",sql:".sql",html:".html,.htm",css:".css",json:".json",yaml:".yml,.yaml",txt:".txt"},ze=(t,l)=>{t.forEach(s=>{l.add(s.id),s.children.length&&ze(s.children,l)})},Gt=(t,l)=>{const s=[],e=(r,a)=>{r.forEach(n=>{s.push({node:n,depth:a}),n.children.length&&l.has(n.id)&&e(n.children,a+1)})};return e(t,0),s},sn=()=>{const{languageId:t,changeLanguage:l,source:s,setSource:e,outline:r,outlineCount:a,diagnostics:n,engine:i,loading:d,error:o,handleAnalyze:p,handleFileSelect:h,handleSampleLoad:w,fileInputRef:k,languageOptions:y}=Vt(),C=Ie(),$=Pe(C.breakpoints.up("md")),L=v.useMemo(()=>a?`${a}개의 최상위 심볼`:"결과 없음",[a]),E=v.useRef(null),B=v.useRef(!1),[R,F]=v.useState(.55),m=R,I=1-R,[b,z]=v.useState(null),j=Jt[t]??".js,.ts,.tsx,.java,.kt,.py,.go,.rs,.c,.cpp,.cc,.cxx,.hpp,.hh,.hxx,.cs,.php,.rb,.scala,.sql,.html,.htm,.css,.json,.yml,.yaml,.txt",[x,S]=v.useState(new Set),[A,D]=v.useState(null),M=v.useRef(null),U=v.useRef(null),[q,H]=v.useState({width:0,height:0}),T=v.useMemo(()=>Gt(r,x),[r,x]),J=v.useCallback(u=>{S(f=>{const g=new Set(f);return g.has(u)?g.delete(u):g.add(u),g})},[]),V=v.useCallback(u=>{D(u.id);const f=u.line+1,g=M.current;g&&(g.revealLineInCenter(f),g.setSelection({startLineNumber:f,startColumn:1,endLineNumber:f,endColumn:1}),g.focus())},[]),se=v.useCallback(({index:u,style:f})=>{const{node:g,depth:P}=T[u],N=g.children.length>0,re=x.has(g.id),Y=g.id===A;return c.jsxs(Z,{style:f,sx:{display:"flex",alignItems:"center",pl:1+P*1.5,pr:1,gap:1,cursor:"pointer",bgcolor:Y?"action.selected":void 0},onClick:()=>V(g),children:[N?c.jsx(ae,{size:"small",onClick:ne=>{ne.stopPropagation(),J(g.id)},children:re?c.jsx(Le,{fontSize:"small"}):c.jsx(Me,{fontSize:"small"})}):c.jsx(Z,{sx:{width:32}}),c.jsx(Z,{sx:{display:"flex",color:"text.secondary"},children:je(g.kind)}),c.jsx(X,{variant:"body2",fontWeight:600,noWrap:!0,component:"span",children:g.label}),g.annotation&&c.jsx(X,{component:"span",variant:"caption",color:"text.secondary",noWrap:!0,sx:{ml:.5},children:g.annotation}),c.jsxs(X,{variant:"caption",color:"text.secondary",children:["L",g.line+1]})]})},[x,V,J,A,T]),O=v.useCallback(u=>Math.min(Math.max(u,.2),.8),[]),W=v.useCallback(u=>{if(!E.current)return;const f=E.current.getBoundingClientRect();if(f.width<=0)return;const g=(u-f.left)/f.width;F(O(g))},[O]),G=v.useCallback(()=>{B.current=!1,document.body.style.cursor="",document.body.style.userSelect=""},[]),_=v.useCallback(u=>{if($)if(B.current=!0,document.body.style.cursor="col-resize",document.body.style.userSelect="none","touches"in u){const f=u.touches[0];f&&W(f.clientX)}else W(u.clientX)},[$,W]);return v.useEffect(()=>{const u=P=>{B.current&&(P.preventDefault(),W(P.clientX))},f=P=>{if(!B.current)return;const N=P.touches[0];N&&(P.preventDefault(),W(N.clientX))},g=()=>G();return window.addEventListener("mousemove",u),window.addEventListener("mouseup",g),window.addEventListener("touchmove",f,{passive:!1}),window.addEventListener("touchend",g),window.addEventListener("touchcancel",g),()=>{window.removeEventListener("mousemove",u),window.removeEventListener("mouseup",g),window.removeEventListener("touchmove",f),window.removeEventListener("touchend",g),window.removeEventListener("touchcancel",g)}},[G,W]),v.useEffect(()=>{$?F(u=>O(u||.55)):(B.current=!1,document.body.style.cursor="",document.body.style.userSelect="",F(1))},[O,$]),v.useEffect(()=>{const u=new Set;ze(r,u),S(u),D(null)},[r]),v.useLayoutEffect(()=>{const u=U.current;if(!u)return;const f=new ResizeObserver(g=>{const P=g[0];P&&H({width:P.contentRect.width,height:P.contentRect.height})});return f.observe(u),()=>f.disconnect()},[]),c.jsxs(Ze,{sx:{p:1.25,display:"flex",flexDirection:"column",gap:1.25,flex:1,minHeight:785,height:"100%",width:1,maxWidth:"100%",overflowX:"hidden"},children:[c.jsxs(ee,{direction:"row",spacing:1.25,alignItems:"center",children:[c.jsxs(Ee,{size:"small",sx:{minWidth:220},children:[c.jsx(Re,{id:"code-outline-language",children:"언어"}),c.jsx(De,{labelId:"code-outline-language",value:t,label:"언어",onChange:u=>l(u.target.value),children:y.map(u=>c.jsx(Oe,{value:u.id,children:u.label},u.id))})]}),c.jsxs(le,{variant:"outlined",startIcon:c.jsx(Te,{}),component:"label",sx:{minWidth:200},children:["파일 업로드",c.jsx("input",{hidden:!0,type:"file",accept:j,ref:k,onChange:u=>{const f=u.target.files?.[0]??null;h(f)}})]}),c.jsx(le,{variant:"outlined",color:"secondary",startIcon:c.jsx(We,{}),onClick:w,sx:{minWidth:200},children:"샘플 코드 불러오기"}),c.jsx(Z,{sx:{flex:1}}),c.jsx(ee,{direction:"row",spacing:1,alignItems:"center",children:c.jsx(le,{variant:"contained",startIcon:d?c.jsx(Ne,{color:"inherit",size:16}):c.jsx(Ue,{}),onClick:()=>p(),disabled:d,children:"Outline 생성"})})]}),c.jsxs(Z,{ref:E,sx:{flex:1,minHeight:0,width:1,display:"grid",flexDirection:"row",gridTemplateColumns:`minmax(0, ${m}fr) 6px minmax(0, ${I}fr)`,gap:1.25,columnGap:1.25,touchAction:"none",contain:"layout paint size",alignItems:"stretch"},children:[c.jsxs(ee,{sx:{border:"1px solid",borderColor:"divider",borderRadius:.75,overflow:"hidden",minHeight:0},children:[c.jsxs(Z,{sx:{px:1.25,py:1.25,borderBottom:"1px solid",borderColor:"divider",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[c.jsx(X,{variant:"subtitle2",children:"편집기"}),c.jsxs(X,{variant:"caption",color:"text.secondary",children:[s.length.toLocaleString()," chars"]})]}),c.jsx(Z,{sx:{flex:1,minHeight:240},children:c.jsx(ut,{height:"100%",defaultLanguage:"typescript",language:t==="java"?"java":"typescript",theme:"vs-dark",value:s,onChange:u=>e(u??""),onMount:u=>{M.current=u},options:{wordWrap:"on",minimap:{enabled:!1},automaticLayout:!0,fontSize:13}})})]}),c.jsx(Z,{sx:{display:"flex",width:6,justifySelf:"stretch",cursor:$?"col-resize":"default",bgcolor:"divider",borderRadius:.75,alignItems:"center",justifyContent:"center",userSelect:"none"},role:"separator","aria-orientation":"vertical",onMouseDown:_,onTouchStart:_,children:c.jsxs(Z,{sx:{display:"flex",flexDirection:"column",gap:.25},children:[c.jsx(Z,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}}),c.jsx(Z,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}}),c.jsx(Z,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}})]})}),c.jsxs(ee,{sx:{border:"1px solid",borderColor:"divider",borderRadius:.75,minHeight:0,overflow:"hidden"},children:[c.jsxs(Z,{sx:{px:1.25,py:1.25,borderBottom:"1px solid",borderColor:"divider",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[c.jsxs(ee,{direction:"row",spacing:1,alignItems:"center",children:[c.jsx(X,{variant:"subtitle2",children:"Outline"}),c.jsx(me,{title:"아이콘 설명",children:c.jsx(ae,{size:"small",onClick:()=>z({title:"Outline 아이콘 안내",items:Se.map(u=>`${u.label} (${u.kind})`)}),children:c.jsx(ge,{fontSize:"small"})})}),i&&c.jsx(be,{size:"small",color:i==="tree-sitter"?"primary":"warning",label:i==="tree-sitter"?"Tree-sitter 성공":"Fallback (간단한 파서)"}),(o||n.length)&&c.jsx(me,{title:o?"에러 상세 보기":i==="fallback"?"Fallback 사용 이유":"분석 정보",children:c.jsx(ae,{size:"small",color:o?"error":i==="fallback"?"warning":"info",onClick:()=>z({title:o?"에러":i==="fallback"?"Fallback 사용 안내":"분석 정보",items:o?[o]:n.length?n:["Tree-sitter 실행에 실패하여 간단한 파서 결과만 표시합니다."]}),children:o?c.jsx(qe,{fontSize:"small"}):i==="fallback"?c.jsx(Be,{fontSize:"small"}):c.jsx(ge,{fontSize:"small"})})})]}),c.jsx(be,{size:"small",label:L,variant:"outlined"})]}),c.jsx(Z,{sx:{flex:1,px:0,py:.5},ref:U,children:r.length&&q.height>0&&q.width>0?c.jsx(Ce,{height:q.height,width:q.width,itemCount:T.length,itemSize:36,overscanCount:8,children:se}):c.jsx(ee,{alignItems:"center",justifyContent:"center",sx:{height:"100%"},spacing:1,children:c.jsx(X,{variant:"body2",color:"text.secondary",children:"분석된 구조가 없습니다. 샘플을 불러오거나 우측 버튼으로 Outline을 생성하세요."})})})]})]}),c.jsxs(Fe,{open:!!b,onClose:()=>z(null),maxWidth:"sm",fullWidth:!0,children:[c.jsxs(Ke,{children:[b?.title,c.jsx(ae,{onClick:()=>z(null),sx:{position:"absolute",right:8,top:1.25},children:c.jsx(He,{})})]}),c.jsx(Ve,{dividers:!0,children:b?.title==="Outline 아이콘 안내"?c.jsx(Z,{sx:{px:1.25,py:.5,borderColor:"divider",display:"flex",flexWrap:"wrap",gap:1.25},children:Se.map(u=>c.jsxs(ee,{direction:"row",spacing:.5,alignItems:"center",sx:{minWidth:120},children:[c.jsx(Z,{sx:{color:"text.secondary",display:"flex"},children:je(u.kind)}),c.jsx(X,{variant:"caption",color:"text.secondary",children:u.label})]},u.kind))}):c.jsx(ee,{spacing:1,children:b?.items.map((u,f)=>c.jsx(X,{variant:"body2",children:u},f))})}),c.jsx(Xe,{children:c.jsx(le,{onClick:()=>z(null),children:"닫기"})})]})]})};export{sn as default};
