const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-am0Lxdd9.js","assets/monaco-BZh3GCvz.js","assets/vendor-BHnfqNCc.js","assets/excel-CUMakpxJ.js","assets/monaco-DyX1CsEw.css"])))=>i.map(i=>d[i]);
import{r as p,j as t,y as ve}from"./vendor-BHnfqNCc.js";import{u as je,p as Se,B as _,I as W,f as Ce,H as Ie,T as z,P as ze,S as R,a1 as Le,a2 as Re,a3 as Ae,a4 as Pe,a as F,aM as $e,aN as Ee,C as Me,aO as De,a7 as ie,a8 as re,X as oe,aP as Te,aQ as Ze,k as Oe,l as Ne,aw as We,m as Fe,o as Ue,aR as qe,aS as He,aT as Be,aU as le,aV as Je,aW as Xe,aX as ce,aY as Ye,aZ as Ke,a_ as Ge}from"./mui-DWpzSE2I.js";import{_ as Qe,F as Ve}from"./monaco-BZh3GCvz.js";import{p as et}from"./tree-sitter-am0Lxdd9.js";import"./excel-CUMakpxJ.js";let B=null;const Y=async()=>(B||(B=Qe(()=>import("./tree-sitter-am0Lxdd9.js").then(e=>e.t),__vite__mapDeps([0,1,2,3,4]))),B),de=e=>{if(!e)return;const l=e.env??(e.env={});typeof l.tree_sitter_progress_callback!="function"&&(l.tree_sitter_progress_callback=()=>0),typeof l.tree_sitter_query_progress_callback!="function"&&(l.tree_sitter_query_progress_callback=()=>0)},tt=()=>{const e=globalThis;if(e.__treeSitterPatched)return;e.__treeSitterPatched=!0;const l=WebAssembly.instantiate,n=(async(s,c)=>(de(c),l(s,c)));if(WebAssembly.instantiate=n,WebAssembly.instantiateStreaming){const s=WebAssembly.instantiateStreaming,c=((a,i)=>(de(i),s(a,i)));WebAssembly.instantiateStreaming=c}};tt();const nt=et,ue=`
      (class_declaration
