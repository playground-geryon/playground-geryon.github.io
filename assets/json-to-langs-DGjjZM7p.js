import{r as i,j as s}from"./vendor-BHnfqNCc.js";import{u as ee,P as te,B as R,x as ne,y as re,S as U,T as z,a as H,a5 as oe,a6 as se,k as ie,l as ae,m as le,ab as ce}from"./mui-DWpzSE2I.js";import{F as X}from"./monaco-BZh3GCvz.js";import"./excel-CUMakpxJ.js";const q=[{id:"java",label:"Java",language:"java"},{id:"dart",label:"Dart",language:"dart"},{id:"typescript",label:"TypeScript",language:"typescript"}],_=(d,y=2)=>{const g=" ".repeat(y),$=d.split(`
...
`;else if(typeof x=="object"&&!Array.isArray(x)){const J=f(g(h)),E=c(x,p+1);n+=`${e}public static class ${J} {

${E.fieldsCode}${E.innerClassesCode}${e}}
