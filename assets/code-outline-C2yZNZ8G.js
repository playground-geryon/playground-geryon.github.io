import{r as p,j as t,w as ve}from"./vendor-CRMzTT1s.js";import{u as je,p as Se,B as _,I as W,f as Ce,H as Ie,T as z,P as ze,S as R,a1 as Le,a2 as Re,a3 as Ae,a4 as Pe,a as U,aM as $e,aN as Ee,C as Me,aO as De,a7 as ie,a8 as re,X as oe,aP as Te,aQ as Ze,k as Oe,l as Ne,aw as We,m as Ue,o as Fe,aR as qe,aS as He,aT as Be,aU as le,aV as Je,aW as Xe,aX as ce,aY as Ye,aZ as Ke,a_ as Ge}from"./mui-72YRxnpM.js";import{M as Qe}from"./monaco-editor-Ce3Iy6Zj.js";import{p as Ve,_ as et}from"./tree-sitter-aGyQ8e2w.js";import"./excel-CUMakpxJ.js";let B=null;const Y=async()=>(B||(B=et(()=>import("./tree-sitter-aGyQ8e2w.js").then(e=>e.t),[])),B),de=e=>{if(!e)return;const l=e.env??(e.env={});typeof l.tree_sitter_progress_callback!="function"&&(l.tree_sitter_progress_callback=()=>0),typeof l.tree_sitter_query_progress_callback!="function"&&(l.tree_sitter_query_progress_callback=()=>0)},tt=()=>{const e=globalThis;if(e.__treeSitterPatched)return;e.__treeSitterPatched=!0;const l=WebAssembly.instantiate,n=(async(s,c)=>(de(c),l(s,c)));if(WebAssembly.instantiate=n,WebAssembly.instantiateStreaming){const s=WebAssembly.instantiateStreaming,c=((a,i)=>(de(i),s(a,i)));WebAssembly.instantiateStreaming=c}};tt();const nt=Ve,ue=`
      (class_declaration
